...
package com.primus.service.base;
...
import com.primus.service.PatientLocalService;
import com.primus.service.PatientService;
import com.primus.service.persistence.PatientPersistence;
...
/**
 * The base implementation of the patient local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.primus.service.impl.PatientLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link com.primus.service.PatientLocalServiceUtil} to access the patient local service.
 * </p>
 *
 ...
 * @generated
 */
public abstract class PatientLocalServiceBaseImpl implements PatientLocalService {
	/**
	...
	public Patient addPatient(Patient patient) throws SystemException {
		...
		return patientPersistence.update(patient, false);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deletePatient(Patient patient) throws SystemException {
		patientPersistence.remove(patient);
	}
	...
	public Patient updatePatient(Patient patient) throws SystemException {
		...
		return patientPersistence.update(patient, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Patient updatePatient(Patient patient, boolean merge)
		throws SystemException {
		patient.setNew(false);

		return patientPersistence.update(patient, merge);
	}

	/**
	 * Gets the patient local service.
	 *
	 * @return the patient local service
	 */
	public PatientLocalService getPatientLocalService() {
	 ...
	 */
	public void setPatientLocalService(PatientLocalService patientLocalService) {
		this.patientLocalService = patientLocalService;
	}

	/**
	 * Gets the patient remote service.
	 *
	...
	@BeanReference(type = PatientLocalService.class)
	protected PatientLocalService patientLocalService;
	@BeanReference(type = PatientService.class)
