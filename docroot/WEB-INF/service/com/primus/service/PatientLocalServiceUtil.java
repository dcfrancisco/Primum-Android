...
/**
 * The utility for the patient local service. This utility wraps {@link com.primus.service.impl.PatientLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 * Never modify this class directly. Add custom service methods to {@link com.primus.service.impl.PatientLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
 * </p>
 *
 * <p>
...
public class PatientLocalServiceUtil {
	...
	*/
	public static com.primus.model.Patient addPatient(
	...
	*/
	public static com.primus.model.Patient createPatient(long patientId) {
	...
	*/
	public static void deletePatient(long patientId)
		...
		getService().deletePatient(patientId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deletePatient(com.primus.model.Patient patient)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deletePatient(patient);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.primus.model.Patient getPatient(long patientId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.primus.model.Patient> getPatients(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.primus.model.Patient updatePatient(
		com.primus.model.Patient patient)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static com.primus.model.Patient updatePatient(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updatePatient(patient, merge);
	}

	public static java.util.List<com.primus.model.Patient> getPatientsByCompanyId(
		long companyId) {
		return getService().getPatientsByCompanyId(companyId);
	}

	public static int getPatientsByCompanyIdCount(long companyId) {
		return getService().getPatientsByCompanyIdCount(companyId);
	}

	public static java.util.List<com.primus.model.Patient> getPatientsByCreatorUserId(
		long creatorUserId) {
		return getService().getPatientsByCreatorUserId(creatorUserId);
	}

	public static int getPatientsByCreatorUserIdCount(long creatorUserId) {
		return getService().getPatientsByCreatorUserIdCount(creatorUserId);
	}

	public static java.util.List<com.primus.model.Patient> getPatientsByGroup(
		long groupId) {
		return getService().getPatientsByGroup(groupId);
	}

	public static int getPatientsByGroupCount(long groupId) {
		return getService().getPatientsByGroupCount(groupId);
	}
	...
	public static PatientLocalService getService() {
		if (_service == null) {
			...
			_service = new PatientLocalServiceClp(classLoaderProxy);
